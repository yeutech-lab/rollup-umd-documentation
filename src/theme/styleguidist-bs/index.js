...
export function makeTheme(userTheme = { styleguide: {} }) {
  ...
  v['$rsg-path-line-font-size'] = u['$rsg-path-line-font-size'] || v['$rsg-font-size'].xs;
  ...
  // Props table
  v['$rsg-name-font-size'] = u['$rsg-name-font-size'] || v['$rsg-font-size'].xs;
  ...
  v['$rsg-type-font-size'] = u['$rsg-type-font-size'] || v['$rsg-font-size'].xs;
  ...
  v['$rsg-props-description-font-size'] = u['$rsg-props-description-font-size'] || v['$rsg-font-size'].xs;
  // argument
  ...
  // editor
  v['$rsg-editor-padding'] = u['$rsg-editor-padding'] || `2px ${v['$rsg-space'].xs} 2px 2px`;
  v['$rsg-editor-font-family'] = u['$rsg-editor-font-family'] || v['$rsg-font-family-base'];
  v['$rsg-editor-font-size'] = u['$rsg-editor-font-size'] || v['$rsg-font-size'].xs;
  v['$rsg-editor-color'] = u['$rsg-editor-color'] || v['$rsg-gray'];
  v['$rsg-editor-background-color'] = u['$rsg-editor-background-color'] || v['$rsg-color-code-background'];
  ...
  v['$rsg-editor-global-padding'] = u['$rsg-editor-global-padding'] || `${v['$rsg-space'].xxs} ${v['$rsg-space'].xs}`;
  v['$rsg-editor-global-font-size'] = u['$rsg-editor-global-font-size'] || v['$rsg-font-size'].xs;
  ...
  v['$rsg-error-font-size'] = u['$rsg-error-font-size'] || v['$rsg-font-size'].xs;
  ...
  v['$rsg-playground-error-font-size'] = u['$rsg-playground-error-font-size'] || v['$rsg-font-size'].xs;
  ...
  v['$rsg-table-cell-heading-font-size'] = u['$rsg-table-cell-heading-font-size'] || v['$rsg-font-size'].xs;
  ...
  v['$rsg-table-cell-font-size'] = u['$rsg-table-cell-font-size'] || v['$rsg-font-size'].xs;
  ...
  v['$rsg-markdown-pre-font-size'] = u['$rsg-markdown-pre-font-size'] || v['$rsg-font-size'].xs;
