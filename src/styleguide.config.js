...
export const config = {
  ...
  styleguideComponents: {
    ...
    ComponentsRenderer: path.join(__dirname, '../lib/rsg-components/Components/ComponentsRenderer.js'),
    ...
    Markdown: path.join(__dirname, '../lib/rsg-components/Markdown'),
    Blockquote: path.join(__dirname, '../lib/rsg-components/Markdown/Blockquote'),
    BlockquoteRenderer: path.join(__dirname, '../lib/rsg-components/Markdown/Blockquote/BlockquoteRenderer.js'),
    Checkbox: path.join(__dirname, '../lib/rsg-components/Markdown/Checkbox'),
    CheckboxRenderer: path.join(__dirname, '../lib/rsg-components/Markdown/Checkbox/CheckboxRenderer.js'),
    Hr: path.join(__dirname, '../lib/rsg-components/Markdown/Hr'),
    HrRenderer: path.join(__dirname, '../lib/rsg-components/Markdown/Hr/HrRenderer.js'),
    List: path.join(__dirname, '../lib/rsg-components/Markdown/List'),
    ListRenderer: path.join(__dirname, '../lib/rsg-components/Markdown/List/ListRenderer.js'),
    MarkdownHeading: path.join(__dirname, '../lib/rsg-components/Markdown/MarkdownHeading'),
    MarkdownHeadingRenderer: path.join(__dirname, '../lib/rsg-components/Markdown/MarkdownHeading/MarkdownHeadingRenderer.js'),
    Pre: path.join(__dirname, '../lib/rsg-components/Markdown/Pre'),
    PreRenderer: path.join(__dirname, '../lib/rsg-components/Markdown/Pre/PreRenderer.js'),
    TableHeadRenderer: path.join(__dirname, '../lib/rsg-components/Markdown/Table/TableHeadRenderer.js'),
    TableBodyRenderer: path.join(__dirname, '../lib/rsg-components/Markdown/Table/TableBodyRenderer.js'),
    TableRowRenderer: path.join(__dirname, '../lib/rsg-components/Markdown/Table/TableRowRenderer.js'),
    TableCellRenderer: path.join(__dirname, '../lib/rsg-components/Markdown/Table/TableCellRenderer.js'),
    ...
    TableOfContents: path.join(__dirname, '../lib/rsg-components/TableOfContents/TableOfContents'),
